...
DayVault 不是为了销售而做的产品，而是源于我自己的一个想法：我想有一个足够小、
能够全天随身携带的设备，持续记录我说过的话、我参与的对话，以及那些很容易被忘掉的
普通生活片段。

这里要解决的不只是“能不能录音”，手机本身已经能做到。真正的问题是，怎样让记录设备
足够小、稳定、低功耗，并且不影响日常生活。我的计划是每天晚上导出当天的音频，使用 AI
转成文字，再按日期保存为可以搜索和回看的档案。以后我可以知道某一天做过什么、聊过什么，
也能看到自己的生活怎样慢慢发生变化。

DayVault 就是为这套流程设计的硬件：全天佩戴是目标，录音保存在本地 microSD，RTC 负责
时间记录，USB-C 用于充电和导出数据。我很享受这种为生活留下可回看记录的感觉，这也是我
持续开发这个项目的原因。
